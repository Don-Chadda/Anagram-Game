...
public class PublisherInfo implements ActionListener 
{
    ...
    public PublisherInfo()
    {
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:sqlserver://localhost;databaseName=Library;user=sa;password=DonChadda");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if (ae.getActionCommand() == "Insert")
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    JOptionPane.showMessageDialog(f1, "Record already exits.", "Warning Message", JOptionPane.WARNING_MESSAGE);
                    pub_idField.setText("");
                    pub_nameField.setText("");
                    phoneField.setText("");
                    addressField.setText("");
            ...
            {
                JOptionPane.showMessageDialog(f1, "Please fill in details properly.", "Error Message", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
